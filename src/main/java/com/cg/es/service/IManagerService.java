...
public interface IManagerService {
	ManagerModel addManager(ManagerModel managerModel) throws ManagerNotFoundException;
	ManagerModel updateManager(ManagerModel managerModel,Long managerId)throws ManagerNotFoundException;
