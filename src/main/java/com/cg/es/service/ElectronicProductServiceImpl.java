...
public class ElectronicProductServiceImpl implements IElectronicProductService{
	...
	@Override
	public ElectronicProductModel addProduct(ElectronicProductModel electronicProductModel) throws ElectronicProductNotFoundException {
	...
	@Override
	public ElectronicProductModel updateProduct(ElectronicProductModel electronicProductModel, Long productId) throws ElectronicProductNotFoundException {
		if(electronicProductModel != null) {
	...
	@Override
	public ElectronicProductModel findByProductId(Long productId) {
