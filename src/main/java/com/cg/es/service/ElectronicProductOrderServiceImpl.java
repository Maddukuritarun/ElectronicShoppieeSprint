...
public class ElectronicProductOrderServiceImpl implements IElectronicProductOrderService{
	...
	@Override
	public ElectronicProductOrderModel addOrder(ElectronicProductOrderModel orderModel) throws ElectronicProductOrderNotFoundException{
		if (orderModel != null) {
...
//	}
	...
	@Override
	public ElectronicProductOrderModel findByOrderId(Long orderId) {
	...
	@Override
	public ElectronicProductOrderModel updateOrder(ElectronicProductOrderModel orderModel, Long orderId) throws ElectronicProductOrderNotFoundException {
		if(orderModel != null) {
